...
var game = {
    ...
    **/
    ...
    boot: function() {
        ...
        if (typeof this.config.sourceFolder === 'undefined') this.config.sourceFolder = 'flyingdog';
        if (typeof this.config.mediaFolder === 'undefined') this.config.mediaFolder = 'flyingdog';
